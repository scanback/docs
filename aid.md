...
The steps with z are in practice unnecessary. It is better to create two colums. The first with y, the second with z=y/(1-y). The shown z folds this into one column, but what's the point. Columns are cheap.
